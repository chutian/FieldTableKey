...
//#define NAND_ZONE_SIZE             ((u16)0x0400) /* 1020481024 Block per zone */
#define NAND_ZONE_SIZE             ((u16)0x0800) /* 2048 Block per zone */
//#define NAND_SPARE_AREA_SIZE       ((u16)0x0040) /* last 64 bytes as spare area */
#define NAND_SPARE_AREA_SIZE       ((u16)0x0010) /* last 64 bytes as spare area */
