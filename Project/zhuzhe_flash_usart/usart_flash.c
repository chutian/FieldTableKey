...
*********************************************************************************************************
*/
 void UpdateAddress(uint8_t *address,NAND_ADDRESS  NewAddress,unsigned int DateNumber)
{
...
*********************************************************************************************************
*/
 void WriteDate(char *date,unsigned long lenth,unsigned  int DateNumber)
{
...
// unsigned char i;
 ...
 else
 {
  ...
  NAND_WriteSmallPage(date,NewAddress2,16);//old 4
}
